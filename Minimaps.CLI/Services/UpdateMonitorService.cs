...
/// The backend will be queried for unregistered (or registered but unprocessed) builds, and begin processing the tile data into the backend tile store.
...
/// </summary>
internal class UpdateMonitorService() : BaseService("UpdateMonitor", TimeSpan.FromSeconds(10))
{
    private readonly Random _random = new();

    protected override async Task TickInternalAsync(CancellationToken cancellationToken)
    {
